...
class TreeNode:
    ...
    def __repr__(self):
        ...
        return "TreeNode({0}, {1}, children={2}{3})".format(
            self.name, leaf_status, len(self.children), comment_info)
...
class TreeParser:
    ...
    def _parse_shorthand(self, path_string, nodes, stack, base_indent, comment=None):
        ...
        if parent_node:
            ...
            if root is None:
                ...
                root = TreeNode(cleaned_parts[0], comment=root_comment)
        ...
        for i, part in enumerate(cleaned_parts[1:], 1):
            ...
            if child is None:
                child = TreeNode(part, comment=node_comment)
    ...
    def _parse_indented(self, name, nodes, stack, indent, comment=None):
        ...
        node = TreeNode(name, comment=comment)
